package de.lukasringel.loadbalancer.server.application.console

import de.lukasringel.loadbalancer.server.application.console.command.Command
import de.lukasringel.loadbalancer.server.application.console.command.CommandHandler
...
object Console {
  ...
  init {
    ...
    Shutdown.registerShutdownHook { stopCommandReading() }
  }
